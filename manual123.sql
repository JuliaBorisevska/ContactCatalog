...
-- Dumping data for table manual.attachment: ~5 rows (approximately)
/*!40000 ALTER TABLE `attachment` DISABLE KEYS */;
INSERT INTO `attachment` (`id`, `title`, `path`, `upload_date`, `user_comment`, `contact_id`) VALUES
	(1, 'Фото', '1.jpg', '2014-11-09 22:40:45', 'фото', 1),
	(3, 'Текст', '3.doc', '2015-02-28 11:05:12', 'положения', 2),
	(6, 'Первое', '6.jpg', '2015-03-09 22:45:46', NULL, 1),
	(7, 'Второе', '7.jpg', '2015-03-09 22:45:58', NULL, 1),
	(8, 'Стандарт', '8.docx', '2015-03-10 03:48:13', NULL, 5);
...
-- Dumping data for table manual.contact: ~5 rows (approximately)
...
INSERT INTO `contact` (`id`, `first_name`, `last_name`, `midle_name`, `birth_date`, `sex_id`, `marital_status_id`, `citizenship`, `website`, `email`, `image`, `company`, `country`, `town`, `street`, `house`, `flat`, `index_value`) VALUES
	(1, 'Юлия', 'Борисевская', 'Валентиновна', '1994-07-03', 'ж', 4, 'BLR', NULL, 'borisevska.yu@mail.ru', NULL, NULL, 'Беларусь', 'Минск', 'Коласа', NULL, NULL, NULL),
	(2, 'Светлана', 'Каулькина', 'Олеговна', '1964-02-16', 'ж', 2, 'Беларусь', 'www.kaulkina.by', 'kaulkina.s@mail.ru', '2.jpg', 'Торгмаш', 'Беларусь', 'Гродно', 'Лиможа', 50, 262, 155555),
	(3, 'Анастасия', 'Хорошко', 'Валерьевна', '1994-02-09', 'ж', 4, 'Беларусь', NULL, NULL, NULL, 'БГУИР', 'Беларусь', 'Минск', 'Беды', 4, 510, 114558),
	(4, 'Игорь', 'Васильев', 'Аркадьевич', '1958-07-25', 'м', 1, 'Беларусь', 'www.igorv.by', 'vasiliev@gmail.com', NULL, 'Атлант', 'Беларусь', 'Брест', 'Победы', 20, 12, 158999),
	(5, 'Борис ', 'Новиков', 'Анатольевич', '1980-04-17', 'м', 3, '       ', NULL, 'novikov@mail.ru', NULL, NULL, 'Беларусь', 'Могилев', NULL, NULL, NULL, NULL);
